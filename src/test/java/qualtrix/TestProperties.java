...
public class TestProperties {
    ...
    public static String getQualtrixTestKey() throws IOException {
        ...
        return objectMapper
                .readValue(new ClassPathResource("qualtrix-key.json").getInputStream(), TestProperties.class)
                .getQualtrixKey();
    }
    ...
    public static TestProperties properties() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper
                .readValue(new ClassPathResource("qualtrix-test-ids.json").getInputStream(), TestProperties.class);
    }
}
